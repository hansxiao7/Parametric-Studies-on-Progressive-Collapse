...
uniaxialMaterial Concrete01  1  -4.022   -0.0022  -0.804  -0.0183  
# Cover concrete (unconfined)
uniaxialMaterial Concrete01  2  -3.614   -0.002   -0.723   -0.0051 
# beam STEEL
# Reinforcing steel 
...
#change
#Define recorders
recorder Node -file costrained/dEnd.out -time -node 17 -dof 2 disp; 
recorder Node -file costrained/axial_f.out -time -node 17 -dof 1 reaction; 
...
recorder Element -file costrained/ele1sect_end_compreinf.out -time -ele 16 section 5 fiber [expr $y1-$cover] [expr $cover-$z1] stress
recorder Element -file costrained/ele1sect_end_tenreinf.out -time -ele 16 section 5 fiber [expr $cover-$y1] [expr $cover-$z1] stress
