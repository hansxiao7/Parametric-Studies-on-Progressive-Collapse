...
uniaxialMaterial Concrete01  1  -6.907  -0.0021  -1.381  -0.0168  
# Cover concrete (unconfined)
uniaxialMaterial Concrete01  2  -6.5   -0.002   -1.3   -0.0035 
# beam STEEL
# Reinforcing steel 
...
#change
#Define recorders
recorder Node -file uncostrained/dEnd.out -time -node 12 -dof 2 disp; 
recorder Node -file uncostrained/axial_f.out -time -node 12 -dof 1 reaction; 
...
recorder Element -file uncostrained/ele1sect_end_compreinf.out -time -ele 11 section 5 fiber [expr $y1-$cover] [expr $cover-$z1] stress
recorder Element -file uncostrained/ele1sect_end_tenreinf.out -time -ele 11 section 5 fiber [expr $cover-$y1] [expr $cover-$z1] stress
...
pattern Plain 1 1 {
    #change
    eleLoad -range 1 11 -type -beamUniform -0.0741;
}
...
#change
integrator DisplacementControl 12 2 -0.01 
analysis Static
