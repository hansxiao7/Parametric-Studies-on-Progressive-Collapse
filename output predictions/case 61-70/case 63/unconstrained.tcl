...
uniaxialMaterial Concrete01  1  -4.691  -0.0022  -0.938  -0.0177  
# Cover concrete (unconfined)
uniaxialMaterial Concrete01  2  -4.283   -0.002   -0.857   -0.0044  
# beam STEEL
# Reinforcing steel 
...
element $eleType 18  18  19   $np    1       1


#change
#Define recorders
recorder Node -file uncostrained/dEnd.out -time -node 19 -dof 2 disp; 
recorder Node -file uncostrained/axial_f.out -time -node 19 -dof 1 reaction; 
...
recorder Element -file uncostrained/ele1sect_end_compreinf.out -time -ele 18 section 5 fiber [expr $y1-$cover] [expr $cover-$z1] stress
recorder Element -file uncostrained/ele1sect_end_tenreinf.out -time -ele 18 section 5 fiber [expr $cover-$y1] [expr $cover-$z1] stress
...
pattern Plain 1 1 {
    #change
    eleLoad -range 1 18 -type -beamUniform -0.0741;
}
...
#change
integrator DisplacementControl 19 2 -0.01 
analysis Static
