...
#change
#Define recorders
recorder Node -file costrained/dEnd.out -time -node 19 -dof 2 disp; 
recorder Node -file costrained/axial_f.out -time -node 19 -dof 1 reaction; 
...
recorder Element -file costrained/ele1sect_end_compreinf.out -time -ele 18 section 5 fiber [expr $y1-$cover] [expr $cover-$z1] stress
recorder Element -file costrained/ele1sect_end_tenreinf.out -time -ele 18 section 5 fiber [expr $cover-$y1] [expr $cover-$z1] stress
