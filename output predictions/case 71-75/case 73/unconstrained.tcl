...
uniaxialMaterial Concrete01  1  -7.867  -0.0021  -1.573  -0.0165  
# Cover concrete (unconfined)
uniaxialMaterial Concrete01  2  -7.459   -0.002   -1.492   -0.0032 
# beam STEEL
# Reinforcing steel 
...
#change
#Define recorders
recorder Node -file uncostrained/dEnd.out -time -node 16 -dof 2 disp; 
recorder Node -file uncostrained/axial_f.out -time -node 16 -dof 1 reaction; 
...
recorder Element -file uncostrained/ele1sect_end_compreinf.out -time -ele 15 section 5 fiber [expr $y1-$cover] [expr $cover-$z1] stress
recorder Element -file uncostrained/ele1sect_end_tenreinf.out -time -ele 15 section 5 fiber [expr $cover-$y1] [expr $cover-$z1] stress
...
pattern Plain 1 1 {
    #change
    eleLoad -range 1 15 -type -beamUniform -0.0741;
}
...
#change
integrator DisplacementControl 16 2 -0.01 
analysis Static
